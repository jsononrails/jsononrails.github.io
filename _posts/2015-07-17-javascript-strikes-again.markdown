...
However in Internet Explorer/Chrome this completely fails and a null reference exception is thrown so I had to explicitly specify the key names and their respective value pairs on the push in order to get this to work cross browser.
